...
Permettre d'entrer par une question — « qui parle de la déviance ? » — plutôt
que par un nom d'auteur.
...
L'écran [Domaine](/documentation/guide/domaine).
...
| Cas | Message |
|---|---|
| Identifiant de domaine inconnu | « Introuvable — Ce domaine n'existe pas. » |
